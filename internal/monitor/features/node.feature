Feature: Controller Monitor
  ...
  Scenario Outline: Testing monitor.nodeModeCleanupPods
    ...
    Examples:
      ...
      | vxflex | "node1"  | 1    | 1    | 1    | 1       | "none"     | "none"      | "KubectlTaint" | "none"                | "none"                             |
      | vxflex | "node1"  | 1    | 1    | 1    | 1       | "none"     | "none"      | "KubectlTaint" | "NodeUnpublishVolume" | "Couldn't completely cleanup node" |
      ...
      | vxflex | "node1"  | 1    | 1    | 1    | 1       | "none"     | "RemoveDir" | "KubectlTaint" | "NodeUnpublishVolume" | "Couldn't completely cleanup node" |
      ...
      | vxflex | "node1"  | 1    | 1    | 1    | 1       | "Unmount"  | "none"      | "KubectlTaint" | "none"                | "none"                             |
      | vxflex | "node1"  | 1    | 1    | 1    | 1       | "Unmount"  | "none"      | "KubectlTaint" | "NodeUnpublishVolume" | "Couldn't completely cleanup node" |
      ...
      | vxflex | "node1"  | 1    | 1    | 1    | 1       | "Unmount"  | "RemoveDir" | "KubectlTaint" | "NodeUnpublishVolume" | "Couldn't completely cleanup node" |
      ...
      | vxflex | "node1"  | 3    | 2    | 1    | 2       | "none"     | "none"      | "KubectlTaint" | "none"                | "Couldn't completely cleanup node" |
      | vxflex | "node1"  | 3    | 2    | 1    | 2       | "none"     | "none"      | "KubectlTaint" | "NodeUnpublishVolume" | "Couldn't completely cleanup node" |
      ...
      | vxflex | "node1"  | 3    | 2    | 1    | 2       | "none"     | "RemoveDir" | "KubectlTaint" | "NodeUnpublishVolume" | "Couldn't completely cleanup node" |
      ...
      | vxflex | "node1"  | 3    | 2    | 1    | 2       | "Unmount"  | "none"      | "KubectlTaint" | "none"                | "Couldn't completely cleanup node" |
      | vxflex | "node1"  | 3    | 2    | 1    | 2       | "Unmount"  | "none"      | "KubectlTaint" | "NodeUnpublishVolume" | "Couldn't completely cleanup node" |
      ...
      | vxflex | "node1"  | 3    | 2    | 1    | 2       | "Unmount"  | "RemoveDir" | "KubectlTaint" | "NodeUnpublishVolume" | "Couldn't completely cleanup node" |
