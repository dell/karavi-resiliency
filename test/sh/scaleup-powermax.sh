...
if [ "$ISVIRTUALIZATION" = true ]; then
	...
	cd ../podmontest; sh inspm.sh --instances "$instances" --nvolumes $NVOLUMES --storage-class $STORAGECLASS --workload-type vm; cd $CWD
	wait_on_running_vms
	sh ../sh/nway.sh --ns powermax --bounceipseconds $BOUNCEIPTIME --maxiterations 12 --timeoutseconds 1200 --workload-type vm --node-user core
	fi
	...
	cd ../podmontest; sh inspm.sh --instances "$instances" --nvolumes $NVOLUMES --storage-class $STORAGECLASS --workload-type vm; cd $CWD
	wait_on_running_vms
	sh ../sh/nway.sh --ns powermax --bounceipseconds $BOUNCEIPTIME --maxiterations 12 --timeoutseconds 1800 --workload-type vm --node-user core
	fi
	...
	cd ../podmontest; sh inspm.sh --instances "$instances" --nvolumes $NVOLUMES --storage-class $STORAGECLASS --workload-type vm; cd $CWD
	wait_on_running_vms
	sh ../sh/nway.sh --ns powermax --bounceipseconds $BOUNCEIPTIME --maxiterations 12 --timeoutseconds 2100 --workload-type vm --node-user core
	fi
	...
	cd ../podmontest; sh inspm.sh --instances "$instances" --nvolumes $NVOLUMES --storage-class $STORAGECLASS --workload-type vm; cd $CWD
	wait_on_running_vms
	sh ../sh/nway.sh --ns powermax --bounceipseconds $BOUNCEIPTIME --maxiterations 12 --timeoutseconds 2300 --workload-type vm --node-user core
	fi
	...
	cd ../podmontest; sh inspm.sh --instances "$instances" --nvolumes $NVOLUMES --storage-class $STORAGECLASS --workload-type vm; cd $CWD
	wait_on_running_vms
	sh ../sh/nway.sh --ns powermax --bounceipseconds $BOUNCEIPTIME --maxiterations 12  --timeoutseconds 2500 --workload-type vm --node-user core
	fi
	...
	cd ../podmontest; sh inspm.sh --instances "$instances" --nvolumes $NVOLUMES --storage-class $STORAGECLASS --workload-type vm; cd $CWD
	wait_on_running_vms
	sh ../sh/nway.sh --ns powermax --bounceipseconds $BOUNCEIPTIME --maxiterations 12  --timeoutseconds 2800 --workload-type vm --node-user core
	fi
else
	BOUNCEIPTIME=240
	instances="4"
